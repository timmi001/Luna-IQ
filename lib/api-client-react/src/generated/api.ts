 ...
 */
export const getSaveLunaLogUrl = () => {
  return `/api/luna/log`;
};

export const saveLunaLog = async (
  saveLunaLogBody: SaveLunaLogBody,
  options?: RequestInit,
): Promise<LunaLog> => {
  return customFetch<LunaLog>(getSaveLunaLogUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(saveLunaLogBody),
  });
};

export const getSaveLunaLogMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof saveLunaLog>>,
    TError,
    { data: BodyType<SaveLunaLogBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return saveLunaLog(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type SaveLunaLogMutationResult = NonNullable<
  Awaited<ReturnType<typeof saveLunaLog>>
>;
export type SaveLunaLogMutationBody = BodyType<SaveLunaLogBody>;
export type SaveLunaLogMutationError = ErrorType<unknown>;

/**
 * @summary Save a daily wellness log
 */
export const useSaveLunaLog = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getSaveLunaLogMutationOptions(options));
};

/**
 * @summary Get user logs
 */
export const getGetLunaLogsUrl = (userId: string) => {
  return `/api/luna/logs/${userId}`;
};

export const getLunaLogs = async (
  userId: string,
  options?: RequestInit,
): Promise<LunaLog[]> => {
  return customFetch<LunaLog[]>(getGetLunaLogsUrl(userId), {
    ...options,
    method: "GET",
  });
};

export const getGetLunaLogsQueryKey = (userId: string) => {
  return [`/api/luna/logs/${userId}`] as const;
};

export const getGetLunaLogsQueryOptions = <
  TData = Awaited<ReturnType<typeof getLunaLogs>>,
  TError = ErrorType<unknown>,
>(
  userId: string,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getLunaLogs>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetLunaLogsQueryKey(userId);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getLunaLogs>>> = ({
    signal,
  }) => getLunaLogs(userId, { signal, ...requestOptions });
...
export type GetLunaLogsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getLunaLogs>>
>;
export type GetLunaLogsQueryError = ErrorType<unknown>;

/**
 * @summary Get user logs
 */

export function useGetLunaLogs<
  TData = Awaited<ReturnType<typeof getLunaLogs>>,
  TError = ErrorType<unknown>,
>(
  userId: string,
  ...
  const queryOptions = getGetLunaLogsQueryOptions(userId, options);
 ...
 */
export const getGenerateLunaInsightUrl = () => {
  return `/api/luna/generate-insight`;
};

export const generateLunaInsight = async (
  generateLunaInsightBody: GenerateLunaInsightBody,
  options?: RequestInit,
): Promise<LunaInsightResponse> => {
  return customFetch<LunaInsightResponse>(getGenerateLunaInsightUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(generateLunaInsightBody),
  });
};

export const getGenerateLunaInsightMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof generateLunaInsight>>,
    TError,
    { data: BodyType<GenerateLunaInsightBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["generateLunaInsight"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return generateLunaInsight(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type GenerateLunaInsightMutationResult = NonNullable<
  Awaited<ReturnType<typeof generateLunaInsight>>
>;
export type GenerateLunaInsightMutationBody = BodyType<GenerateLunaInsightBody>;
export type GenerateLunaInsightMutationError = ErrorType<unknown>;

/**
 * @summary Generate AI wellness insight for a user
 */
export const useGenerateLunaInsight = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getGenerateLunaInsightMutationOptions(options));
};

/**
 * @summary Chat with Luna AI companion (SSE stream)
 */
export const getLunaChatUrl = () => {
  return `/api/luna/chat`;
};

export const lunaChat = async (
  lunaChatBody: LunaChatBody,
  options?: RequestInit,
): Promise<unknown> => {
  return customFetch<unknown>(getLunaChatUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(lunaChatBody),
  });
};

export const getLunaChatMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof lunaChat>>,
    TError,
    { data: BodyType<LunaChatBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return lunaChat(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type LunaChatMutationResult = NonNullable<
  Awaited<ReturnType<typeof lunaChat>>
>;
export type LunaChatMutationBody = BodyType<LunaChatBody>;
export type LunaChatMutationError = ErrorType<unknown>;
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getLunaChatMutationOptions(options));
};
